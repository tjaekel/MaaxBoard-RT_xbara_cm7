...
void BOARD_InitPins(void) {
  ...
  /* use I2C3_SCL on J1, pin 5, as an output from XBAR */
  IOMUXC_SetPinMux(
  ...
  /* configure as XBAR input or regular GPIO */
  /* this is regular GPIO input */
  gpio_pin_config_t USER_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_NoIntmode
  };
  GPIO_PinInit(GPIO11, 12U, &USER_config);
  ...
  IOMUXC_SetPinMux(
        ...
        0x00U);
#else
  /* this enabled as input for XBAR */
  IOMUXC_SetPinMux(
